...
namespace AlephNote.Common.Themes
{
	public struct CornerRadiusRef
	{
		...
		private CornerRadiusRef(double l, double t, double r, double b)
		{
			_left   = l;
			_top    = t;
			_right  = r;
		...
		public static CornerRadiusRef Create(double v1)
		{
			return new CornerRadiusRef(v1, v1, v1, v1);
		}

		public static CornerRadiusRef Create(double v1, double v2, double v3, double v4)
		{
			return new CornerRadiusRef(v1, v2, v3, v4);
		}

		public static CornerRadiusRef Parse(string ovalue)
		{
